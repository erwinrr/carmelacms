class DepartmentsController < ApplicationController
  ...
  private
    ...
    def department_params
      params.require(:department).permit(:name, :icon, :group_id, user_ids: [])
    end
end
